...
<div id="page-wrapper">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $this->Tna_model->total_tna(); ?></div>
                                    <div>Total TNA Task</div>
                                </div>
                            </div>
                        </div>
                        <a href="<?php echo site_url('Tna/total_task'); ?>">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $this->Tna_model->total_comptna(); ?></div>
                                    <div>complete Task</div>
                                </div>
                            </div>
                        </div>
                        <a href="<?php echo site_url('Tna/get_completedtask/1'); ?>">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $this->Tna_model->total_uncomptna(); ?></div>
                                    <div>Uncompleted Task!</div>
                                </div>
                            </div>
                        </div>
                        <a href="<?php echo site_url('Tna/get_unclompltedtask/'); ?>">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
            ...
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Daily Production Chart 24 Hours
