...
<head>
    ...
    <link href="<?php echo site_url('assets/startbootstrap-admin'); ?>/vendor/datatables-plugins/dataTables.bootstrap.css" rel="stylesheet">
    <link href="<?php echo site_url('assets/startbootstrap-admin'); ?>/vendor/datatables-responsive/dataTables.responsive.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">TNA</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?php echo site_url('Tna/download_tna');?>"><i class="fa fa-user fa-fw"></i> Download Status</a>
                        </li>
                        <li><a href="<?php echo site_url('Order/put_detail'); //echo site_url('Tna/enter_detail');?>"><i class="fa fa-gear fa-fw"></i> New Order </a>
                        </li>
                        <li class="divider"></li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       ...
                       <li>
                        ...
                        <li>
                            <a href="<?php echo site_url('Order/view_report'); ?>"><i class="fa fa-table fa-fw"></i> View Current Status</a>
                        </li>
                        <li>
