...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js" type="text/javascript"></script>
   ...
   // formData='<?php //$this->load->view('manager/'.$formdata); ?>';
     formData='[{"type": "text","required": true,"label": "Order_number","placeholder": "Order Number","name": "order_number","subtype": "text","className": "red form-control"},{"type": "date","required": true,"label": "ORIGINAL SAMPLE GIVEN","description": "ORIGINAL SAMPLE GIVEN Date","className": "form-control","name": "dateA"},{"type": "radio-group","required": true,"label": "TIME PERIOD","description": "Total Times IN days","name": "tna_time","values": [{"label": "60 Days","value": "60","selected": true},{"label": "80 Days","value": "80"},{"label": "90 Days","value": "90"},{"label": "75 Days","value": "75"}]},{"type": "button","subtype": "submit","label": "Button","className": "btn btn-default","name": "button-1522838793204","style": "default"}]';
